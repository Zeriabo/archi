...
/* harmony import */ var _common_getSiblings__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1311);
...
const Navbar = ({ navbarRef , logoRef , logoClass  })=>{
    ...
    const handleDropdown = (e)=>{
        (0,_common_getSiblings__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(e.target.parentElement).filter((item)=>item.classList.contains("show")
        ).map((item)=>{
